...
func (*HtmlHandler) Category(w http.ResponseWriter, request *http.Request) {

	path := request.URL.Path
	categoryId := strings.TrimPrefix(path, "/c/")
	...
	posts := dao.GetPostByCategoryId(cid, pageNo, pageSize)
	...
	categoryResp := &models.CategoryResp{
		HomeResp:     *homeResp,
		CategoryName: categoryName,
	}
	models.Pages.Category.WriteData(w, categoryResp)
}
