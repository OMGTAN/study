# 设置主机名
sudo hostnamectl set-hostname k8s-node02 && bash
...
tar xvf containerd-1.6.21-linux-amd64.tar.gz
...
# 节点加入控制 24小时过期
kubeadm join 10.21.18.91:6443 --token wkalia.x7cf2s33hiluzjg5 --discovery-token-ca-cert-hash sha256:f4adbae15af1fe985431fe2ec60307f2e66694058992b4dd5485836ccb80f237
...
# 设置标签
# kubectl label nodes $HOSTNAME node-role.kubernetes.io/work=work
